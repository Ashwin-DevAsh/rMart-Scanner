...
import {includes,remove, pull, filter} from 'lodash'
...
export default function SelectDeliverableProduct({open,onClose}) {
  ...
  const filterProducts = (products)=>{
    ...
    products.forEach((item)=>{
      console.log(item)
        if(AvailableProducts.indexOf(item.productid) > -1){
             ...
             allProducts.map((item,index)=>{
               ...
               return(<div>
                  <ListItem key={index} button >
                   ...
                   <Switch
                    defaultChecked={item.isavaliable}
